    ...
    'routes' => [
        [
            ...
            'match' => [
                 ...
                 */
                'prefixes' => ['admin/medicines','admin/add-edit-medicine/{id?}','admin/manufacturers','admin','admin/admin_dashboard','admin/logout','/','medicine/{id}','login-page','registration-page','clogin','cregister','logout'],
