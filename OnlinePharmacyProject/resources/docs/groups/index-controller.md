...
<body>
  ...
  <div class="input-group">
    ...
    <div class="input-group-btn">
      ...
      <input type="hidden" name="_token" value="GngmKvQC9JQ4Qy8p0XOsr97lMT9FxFPaJRf1vpgL">      <ul class="nav navbar-nav navbar-right">
				...
				<ul class="thumbnails">
						...
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<h4 style="text-align:center"><a class="btn btn-primary" href="#">60 Tk</a><a class="btn" href="/medicine/6">View Details</a> </h4>
							</div>
						</div>
					</li>
                					<li class="span3">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<h4 style="text-align:center"><a class="btn btn-primary" href="#">180 Tk</a><a class="btn" href="/medicine/5">View Details</a> </h4>
							</div>
						</div>
					</li>
                					<li class="span3">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<h4 style="text-align:center"><a class="btn btn-primary" href="#">8 Tk</a><a class="btn" href="/medicine/4">View Details</a> </h4>
							</div>
						</div>
					</li>
                					<li class="span3">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<h4 style="text-align:center"><a class="btn btn-primary" href="#">50 Tk</a><a class="btn" href="/medicine/3">View Details</a> </h4>
							</div>
						</div>
					</li>
                				</ul>
