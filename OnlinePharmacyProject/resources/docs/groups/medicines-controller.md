...
```bash
curl -X GET \
    -G "http://localhost/admin/add-edit-medicine/0.449" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"medicine":{"manufacturerId":1,"medicineName":"Alatrol","generic":"Cetirizine Hydrochloride","type":"Tablet","quantity":10,"dose":"2.5 mg","medicinePrice":35,"stock":100,"description":"This medicine.....","medicineImage":"voluptatem"},"data":"harum","getManufacturers":"cum","medicineData":"delectus"}'

```

```javascript
const url = new URL(
    "http://localhost/admin/add-edit-medicine/0.449"
);
...
let body = {
    "medicine": {
        ...
        "medicineImage": "voluptatem"
    },
    "data": "harum",
    "getManufacturers": "cum",
    "medicineData": "delectus"
}
