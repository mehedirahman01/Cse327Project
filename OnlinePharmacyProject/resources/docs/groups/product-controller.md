...
```bash
curl -X GET \
    -G "http://localhost/medicine/6077.22059" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"productDetails":"molestias"}'

```

```javascript
const url = new URL(
    "http://localhost/medicine/6077.22059"
);
...
```json
{
    ...
    "exception": "Error",
    "file": "C:\\Users\\Shelby\\Desktop\\Cse327Project\\OnlinePharmacyProject\\app\\Http\\Controllers\\Front\\ProductController.php",
    "line": 26,
    "trace": [
        {
...
<h3>
    ...
    <button type="submit" style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-executetryout-GETmedicine--id-" hidden>Send Request 💥</button>
    </h3>
<p>
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"request":"laborum","session_id":"blanditiis","create":"excepturi","message":"harum"}'
...
<h3>
    Request&nbsp;&nbsp;&nbsp;
        <button type="button" style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-tryout-GETsearch" onclick="tryItOut('GETsearch');">Try it out ⚡</button>
    ...
    <button type="submit" style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-executetryout-GETsearch" hidden>Send Request 💥</button>
    </h3>
<p>
<small class="badge badge-green">GET</small>
